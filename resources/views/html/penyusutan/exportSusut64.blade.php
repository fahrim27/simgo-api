...
<body>
		<h2 style="text-align: center;">Laporan Penyusutan KIB 64</h2>
	  ...
	  <div class="table-responsive">
		        ...
		        <td>Rp. {{number_format($dt['nilai_buku'], 2, ',','.')}}</td>
		        	<?php
		        		$total_perolehan += $dt['nilai_perolehan'];
			      		...
			      		$total_penyusutanBerjalan += $dt['beban'];
			      		$total_beban += $dt['akumulasi_penyusutan_berjalan'];
        ...
        <htmlpagefooter name="page-footer">
            <table class="footer">
                <tr>
                    <td>
                        Laporan Penyusutan KIB 64 {{$nama_lokasi}} {{date('Y')-1}}
                    </td>

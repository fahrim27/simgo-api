...
<body>
	<center>
		<h2 style="text-align:center;">Laporan Rekap Realisasi {{$nama_lokasi}} {{date('Y')-1}}</h2>
	</center>
          ...
          @foreach($data as $dt)
		   ...
		   @endforeach
		   	  <tr>
		   	  	...
		   	  	<td style="color: black; border-bottom: 1px solid black;"></td>
    ...
    <htmlpagefooter name="page-footer">
        <table class="footer">
            <tr>
                <td>
                    Laporan Rekap Realisasi {{$nama_lokasi}} {{date('Y')-1}}
                </td>

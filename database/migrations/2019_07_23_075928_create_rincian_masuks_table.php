...
class CreateRincianMasuksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rincian_masuks', function (Blueprint $table) {
            ...
            $table->string('no_register', 50)->nullable();
    ...
    {
        Schema::dropIfExists('rincian_masuks');
    }
}

...
class LaporanMutasiKeluar108Export implements FromCollection, WithHeadings, WithEvents, WithTitle, WithColumnFormatting, WithHeadingRow, WithCustomStartCell, ShouldAutoSize
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        foreach ($data as $value) {
            ...
            $total_harga_total_tmp = $value['nilai_keluar'];
    ...
    public function headings(): array
    {
        $headings = [
            [
                "LOKASI TUJUAN", "NO BA ST", "TGL BA ST",
                "NO REGISTER", "KODE 108", "KODE 64",
                "TAHUN NAMA BARANG", "MERK/ALAMAT",

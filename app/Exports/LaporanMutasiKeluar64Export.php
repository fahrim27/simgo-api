...
class LaporanMutasiKeluar64Export implements FromCollection, WithHeadings, WithEvents, WithTitle, WithColumnFormatting, WithHeadingRow, WithCustomStartCell, ShouldAutoSize
{
    /**
    ...
    */
    ...
    public function headings(): array
    {
        $headings = [
            [
                "LOKASI TUJUAN", "NO REGISTER",
                "KODE 108", "KODE 64", "NAMA BARANG",
                "MERK/ALAMAT", "TAHUN PENGADAAN",
                "MASA MANFAAT", "MASA TERPAKAI",
                "MASA SISA", "NILAI PEROLEHAN",
                "AKUMULASI PENYUSUTAN", "BEBAN", "NILAI BUKU"
            ],
            [
                2,3,
                4,5,6,

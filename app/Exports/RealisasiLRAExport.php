...
class RealisasiLRAExport implements FromCollection, WithHeadings, WithEvents, WithTitle, WithColumnFormatting, WithHeadingRow, WithCustomStartCell, ShouldAutoSize
{
    /**
    ...
    */
	...
	function __construct($args){
        ...
        $this->total_nilai_spk_penunjang = 0;
        $this->total_nilai_realisasi = 0;
	}
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->setCellValue('E'.$baris_total, $this->total_nilai_spk_penunjang);
